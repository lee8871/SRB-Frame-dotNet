...
namespace SRB_access
{
    public class Access
    {
        ...
        public override string ToString()
        {
            ...
            {
                st_recv = support.ByteArrayToString(recv_data);
            }
            ...
            {
                st_send = support.ByteArrayToString(send_data);
            }
            string st = System.String.Format(
                 @"Addr:{0}.{1} Send:{2}Recv:{3}",
                 support.ByteToString(addr),
        ...
        static public AccessControler defaultAC;
