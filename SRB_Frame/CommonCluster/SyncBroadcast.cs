    ...
    public partial class BaseNode
    {
        public partial class SyncCluster : BaseNode.ICluster
        {
            public class Broadcast
            {
                ...
                public byte recordTimeBroadcast()
                {
                ...
                public void syncToAimNode(byte aim_node_addr, dInfoOut details)
                {
                    byte sno;
                ...
                public void calibratClean(dInfoOut details)
                {
                    ...
                    if (clock_base_node == null)
                    {
                        if (details != null)
                        {
                            write(details, "#### Calibrat to base clock node - All \n");
                            write(details, "+ Can not find base clock node.\n");
                        }
                        return;
                    }
